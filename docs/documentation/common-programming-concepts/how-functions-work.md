...
project’s _src/main.rs_ file with the preceding example and run it using `cargo run`:
...
value. _Expressions_ evaluate to a resulting value. Let’s look at some examples.
